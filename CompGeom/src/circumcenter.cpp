...
void tetcircumcenter(const double a[3], const double b[3], const double c[3], const double d[3],
...
/*****************************************************************************/
void tricircumcenter(const double a[2], const double b[2], const double c[2], double circumcenter[2],
...
/*****************************************************************************/
/*****************************************************************************/
void tricircumcenter3d(const double a[3], const double b[3], const double c[3], double circumcenter[3],
                       double *xi, double *eta)
{
...
/****************************************************************************/
void TriCircumCenter2D( const double *a, const double *b, const double *c, double *result)
{
    double param[2];
    TriCircumCenter2D( a, b, c, result, param);
}
/****************************************************************************/
...
/****************************************************************************/
void TriCircumCenter3D( const double *a, const double *b, const double *c, double *result,
                        double *param)
{
    result[0] = 0.0;
    result[1] = 0.0;
...
/****************************************************************************/
void TetCircumCenter( const double *a, const double *b, const double *c, const double *d, double *result,
                      double *param)
{
...
//  exactinit();
    for( int i = 0; i < 100; i++) {
        ...
        dist[0]  = JMath::length(a, result);
        dist[1]  = JMath::length(b, result);
        dist[2]  = JMath::length(c, result);
        dist[3]  = JMath::length(d, result);
