...
JSuggestiveContoursViewer :: JSuggestiveContoursViewer( JaalViewer *p)
{
    viewManager = p;
}

JSuggestiveContoursViewer :: ~JSuggestiveContoursViewer()
{
}

void JSuggestiveContoursViewer ::draw()
{
    qglviewer::Vec p = viewManager->camera()->position();
...
void JSuggestiveContoursViewer :: loadNewMesh( const string &filename)
{
...
void JSuggestiveContoursViewer :: draw_tstrips()
{
...
void JSuggestiveContoursViewer :: make_texture(float width)
{
...
void JSuggestiveContoursViewer :: draw_c_sc_texture(const vector<float> &ndotv,
...
void JSuggestiveContoursViewer::compute_curv_colors()
{
...
void JSuggestiveContoursViewer :: compute_gcurv_colors()
{
...
void JSuggestiveContoursViewer :: make_light_textures(GLuint *texture_contexts)
{
...
void JSuggestiveContoursViewer :: draw_base_mesh()
{
// Draw the basic mesh, which we'll overlay with lines
    ...
    if (draw_curv1) {
        cout << "Draw Curv1 " << draw_edges << endl;
...
void JSuggestiveContoursViewer:: compute_perview(vector<float> &ndotv, vector<float> &kr,
...
trimesh::vec JSuggestiveContoursViewer :: gradkr(int i)
{
...
//////////////////////////////////////////////////////////////////////
float JSuggestiveContoursViewer :: find_zero_linear(float val0, float val1)
{
...
//////////////////////////////////////////////////////////////////////
float JSuggestiveContoursViewer :: find_zero_hermite(int v0, int v1, float val0, float val1,
...
void JSuggestiveContoursViewer::draw_face_isoline2(int v0, int v1, int v2,
...
void JSuggestiveContoursViewer :: draw_face_isoline(int v0, int v1, int v2,
        const vector<float> &val,
        const vector<float> &test_num,
        const vector<float> &test_den,
...
void JSuggestiveContoursViewer :: draw_isolines(const vector<float> &val,
        const vector<float> &test_num,
        const vector<float> &test_den,
        const vector<float> &ndotv,
        bool do_bfcull, bool do_hermite,
...
void JSuggestiveContoursViewer :: draw_segment_ridge(int v0, int v1, int v2,
...
void JSuggestiveContoursViewer :: draw_face_ridges(int v0, int v1, int v2,
        bool do_ridge,
        const vector<float> &ndotv,
...
void JSuggestiveContoursViewer :: draw_mesh_ridges(bool do_ridge, const vector<float> &ndotv,
        bool do_bfcull, bool do_test, float thresh)
{
...
void JSuggestiveContoursViewer :: draw_face_ph(int v0, int v1, int v2, bool do_ridge,
...
void JSuggestiveContoursViewer :: draw_mesh_ph(bool do_ridge, const vector<float> &ndotv, bool do_bfcull,
        bool do_test, float thresh)
{
...
void JSuggestiveContoursViewer :: draw_silhouette(const vector<float> &ndotv)
{
...
void JSuggestiveContoursViewer :: draw_boundaries(bool do_hidden)
{
    themesh->need_faces();
...
void JSuggestiveContoursViewer :: draw_isophotes(const vector<float> &ndotv)
{
    // Light direction
    vec lightdir(&lightdir_matrix[8]);
    /*
...
void JSuggestiveContoursViewer :: draw_topolines(const vector<float> &ndotv)
{
    qglviewer::Vec p = viewManager->camera()->viewDirection();

    // Camera direction and scale
    vec camdir(p[0], p[1], p[2]);
...
void JSuggestiveContoursViewer :: draw_misc(const vector<float> &ndotv, const vector<float> &DwKr,
        bool do_hidden)
{
...
void JSuggestiveContoursViewer :: draw_mesh()
{
...
void JSuggestiveContoursViewer::cls()
{
    glDisable(GL_DITHER);
    glDisable(GL_BLEND);
    glDisable(GL_DEPTH_TEST);
...
void JSuggestiveContoursViewer ::filter_mesh(int dummy)
{
    JWaitCursor waitCursor;
    waitCursor.start();
...
///////////////////////////////////////////////////////////////////////////////
void JSuggestiveContoursViewer ::filter_normals(int dummy)
{
    JWaitCursor waitCursor;
    waitCursor.start();
...
void JSuggestiveContoursViewer ::filter_curv(int dummy)
{
    JWaitCursor waitCursor;
    waitCursor.start();
...
void JSuggestiveContoursViewer ::filter_dcurv(int dummy)
{
    JWaitCursor waitCursor;
    waitCursor.start();
...
void JSuggestiveContoursViewer ::subdivide_mesh(int dummy)
{
    JWaitCursor waitCursor;
    waitCursor.start();
...
///////////////////////////////////////////////////////////////////////////////
void JSuggestiveContoursViewer :: compute_feature_size()
{
...
///////////////////////////////////////////////////////////////////////////////
void JSuggestiveContoursViewer :: largest_eig_2x2(float m1, float m12, float m2, vec2 &e1, float &l1)
{
...
void JSuggestiveContoursViewer :: compute_viewdep_curv(const TriMesh *mesh, int i, float ndotv,
...
///////////////////////////////////////////////////////////////////////////////
void JSuggestiveContoursViewer :: compute_Dt1q1(const TriMesh *mesh, int i, float ndotv,
...
void JSuggestiveContoursViewer :: draw_segment_app_ridge(int v0, int v1, int v2,
        float emax0, float emax1, float emax2,
        float kmax0, float kmax1, float kmax2,
...
void JSuggestiveContoursViewer :: draw_face_app_ridges(int v0, int v1, int v2,
...
void JSuggestiveContoursViewer :: draw_mesh_app_ridges(const vector<float> &ndotv, const vector<float> &q1,
        const vector<vec2> &t1, const vector<float> &Dt1q1,
        bool do_bfcull, bool do_test, float thresh)
{
...
void JSuggestiveContoursViewer :: set_subwindow_viewport(bool draw_box = false)
{
    GLint V[4];
