...
///////////////////////////////////////////////////////////////////////////////
std::shared_ptr<Constraint> JConstraint::shapeConstraintFactory(const std::string &constraintType, const std::vector<int> &idI, Scalar weight, const Matrix3X &positions) {
...
///////////////////////////////////////////////////////////////////////////////
JConstraint::JConstraint(const std::vector<int> &idI, Scalar weight) :
    idI_(idI),
