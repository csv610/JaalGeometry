...
typedef boost::shared_ptr<JDualSheet>  JDualSheetPtr;
typedef boost::shared_ptr<JDualChord>  JDualChordPtr;
typedef boost::shared_ptr<JQuadDual>   JQuadDualPtr;
...
struct JDualSheet {
    ...
    void  addElements(const JCellPtr &cell, const JEdgePtr &parEdge0, const JEdgePtr &parEdge1, const JEdgePtr &parEdge2, const JEdgePtr &parEdge3 )
    {
        ...
        JFacePtr sface = JQuadrilateral::newObject( snodes);
